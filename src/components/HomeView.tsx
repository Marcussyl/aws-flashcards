...
export function HomeView() {
  ...
  return (
    <div className="space-y-10">
      <section className="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900 to-amber-950/40 p-8 sm:p-10">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href="/study?mode=due"
            className="rounded-full bg-amber-400 px-5 py-2.5 text-sm font-semibold text-slate-950 hover:bg-amber-300"
          >
            Study due cards
          </Link>
          <Link
            href="/study"
            className="rounded-full border border-white/15 px-5 py-2.5 text-sm font-semibold text-white hover:border-amber-300/60"
          >
            Shuffle all
          </Link>
          <Link
